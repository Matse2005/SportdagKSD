<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="mr-2 ">
                    <button type="button" x-bind:class="darkMode ? 'bg-ksdGreen' : 'bg-gray-200'"
                        ...
                        class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer w-11 focus:outline-none focus:ring-2 focus:ring-ksdGreen focus:ring-offset-2"
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                <div class="text-base font-medium text-gray-800 dark:text-gray-200">{{ Auth::user()->firstname }}
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="block w-full py-2 pl-3 pr-4 text-base font-medium text-left ">
                <button type="button" x-bind:class="darkMode ? 'bg-ksdGreen' : 'bg-gray-200'"
                    x-on:click="darkMode = !darkMode"
                    class="relative inline-flex flex-shrink-0 h-6 transition-colors duration-200 ease-in-out border-2 border-transparent rounded-full cursor-pointer w-11 focus:outline-none focus:ring-2 focus:ring-ksdGreen focus:ring-offset-2"
                    role="switch" aria-checked="false">
